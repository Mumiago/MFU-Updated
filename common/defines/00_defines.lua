...
NMilitary = {
	...
	ATTRITION_EQUIPMENT_LOSS_CHANCE = 0.007,		   -- Chance for loosing equipment when suffer attrition. Scaled up the stronger attrition is. Then scaled down by equipment reliability.
	ATTRITION_EQUIPMENT_PER_TYPE_LOSS_CHANCE = 0.622, -- Chance for loosing equipment when suffer attrition. Scaled up the stronger attrition is. Then scaled down by equipment reliability.
	...
	RETREAT_SPEED_FACTOR = 0.275,                    -- speed bonus when retreating
...
NAir = {
	...
	ANTI_AIR_PLANE_DAMAGE_FACTOR = 0.11,					-- Anti Air Gun Damage factor
