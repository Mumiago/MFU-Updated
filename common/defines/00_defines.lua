...
NCountry = {
    ...
    INTERCEPTION_BOMBING_WAR_SUPPORT_IMPACT = 0.2,	-- Max impact of interceptions on the war support
	...
	SPECIAL_FORCES_CAP_MIN = 4200,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NResistance = {
	...
	GARRISON_MANPOWER_LOST_BY_ATTACK = 0.04, 	-- Ratio of manpower lost by garrison at each attack on garrison (this number will be reduced by the hardness of garrison template)
	GARRISON_EQUIPMENT_LOST_BY_ATTACK = 0.03, 	-- Ratio of equipment lost by garrison at each attack on garrison (this number will be reduced by the hardness of garrison template)
...
NBuildings = {
	...
	NAVALBASE_REPAIR_MULT = 0.04,		-- Each level of navalbase building repairs X strength. The value is spread on all ships needed reparation. Fe Navalbase lvl 5 x 0.5 str repair = 2.5 str repaired over 10 ships, so each ship repair hourly 0.25 str.
...
NMilitary = {
	...
	LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.055,        -- global damage modifier... but some equipment is returned at end of battles see : EQUIPMENT_COMBAT_LOSS_FACTOR
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.05,        -- global damage modifier
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.016,    -- air global damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.014,    -- global damage modifier
	...
	BASE_FORT_PENALTY = -0.175, 					   -- fort penalty
...
NAir = {
	...
	NAVAL_STRIKE_DAMAGE_TO_STR = 1.0,					-- Balancing value to convert damage ( nanaval_strike_attackval_strike_attack * hits ) to Strength reduction.
	...
	NAVAL_COMBAT_EXTERNAL_PLANES_JOIN_RATIO_PER_DAY = 0.1, -- max extra plane % that ca n join every day
...
NNavy = {
	...
	DETECTION_CHANCE_MULT_AIR_SUPERIORITY_BONUS = 0.375,			-- bonus from air superiority.
	...
	ENEMY_AIR_SUPERIORITY_IMPACT = -1.0,           					-- effect on ship efficiency due to enemy air superiorty
	...
	TRAINING_DAILY_COUNTRY_EXP_FACTOR = 0.0005,						-- Factor used to scale the Daily Country Navy XP gain
	...
	TRAINING_DAILY_COUNTRY_EXP_SHIP_RATIO_FACTOR = 200.0,					-- Factor used to scale the ratio of training ships for the Daily Country Navy XP gain
	...
	SPOTTING_ENEMY_SPOTTING_MULTIPLIER_FOR_RUNNING_AWAY = 0.65,		-- enemy spotting is multiplied by this value to simulate running away
	...
	SPOTTING_MULTIPLIER_FOR_SUB = 1.1,								-- task force sub spotting value is multiplied by this and added to spotting percentage every hour
	...
	RELATIVE_SURFACE_DETECTION_TO_POSITIONING_FACTOR				= 0.05,	-- multiples the surface detection difference between two sides. the side with higher detection will get a bonus of this value
	...
	POSITIONING_PENALTY_FOR_SHIPS_JOINED_COMBAT_AFTER_IT_STARTS		= 0.00, -- each ship that joins the combat will have this penalty to be added into positioning
	MAX_POSITIONING_PENALTY_FOR_NEWLY_JOINED_SHIPS 					= 0.0,  -- the accumulated penalty from new ships will be clamped to this value
	POSITIONING_PENALTY_HOURLY_DECAY_FOR_NEWLY_JOINED_SHIPS			= 1.0,-- the accumulated penalty from new ships will decay hourly by this value
	...
	SUBMARINE_REVEAL_BASE_CHANCE 									= 30,		-- Base factor for submarine detection. It's modified by the difference of a spotter's submarines detection vs submarine visibility. Use this variable for game balancing. setting this too low will cause bad spotting issues.
	...
	NAVAL_COMBAT_AIR_CAPITAL_TARGET_SCORE = 300,
	...
	NAVAL_COMBAT_AIR_LOW_AA_TARGET_SCORE = 25,                           -- how much score factor from low AA guns (scales between 0->this number)
},
