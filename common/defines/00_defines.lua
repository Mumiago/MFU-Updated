...
NMilitary = {
	...
	MAX_DIVISION_SUPPORT_WIDTH = 1,			-- Max width of support in division designer. (MFU: 1 column)
	MAX_DIVISION_SUPPORT_HEIGHT = 6,		-- Max height of support in division designer. (MFU: 8 slots in one vertical column)
