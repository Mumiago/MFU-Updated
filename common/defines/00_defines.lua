...
NMilitary = {
	...
	MAX_DIVISION_SUPPORT_WIDTH = 2,			-- Max width of support in division designer. (MFU: 2 columns)
	MAX_DIVISION_SUPPORT_HEIGHT = 4,		-- Max height of support in division designer. (MFU: 2x4 support slots)
