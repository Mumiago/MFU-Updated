...
NAir = {
	...
	AA_INDUSTRY_AIR_DAMAGE_FACTOR = -0.09,				-- 5x levels = 60% defense from bombing
...
NAI = {
	...
	EQUIPMENT_MARKET_MAX_CONVOY_RATIO_FOR_MARKET_WAR = 0.26,        -- Max ratio of total convoys to use for equipment trade while at war
