...
NProduction = {
	...
	BASE_NAVAL_EQUIPMENT_CONVERSION_IC_COST_FACTOR = 0.225,       -- Fraction of the hull industry cost which is always included in the refitting cost.
	...
	MIN_NAVAL_EQUIPMENT_CONVERSION_IC_COST_FACTOR = -3.00,		-- Minimum fraction of an equipment type's base industry capacity cost to use when converting a naval equipment, such as through ship refitting.
