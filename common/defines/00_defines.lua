...
NCountry = {
	...
	AIR_VOLUNTEER_PLANES_LIMIT = 0.0,				-- Ratio for volunteer planes available for sending in relation to sender air force
	AIR_VOLUNTEER_BASES_CAPACITY_LIMIT = 0.0,		-- Ratio for volunteer planes available for sending in relation to receiver air base capacity
...
NAir = {
	...
	DETECT_CHANCE_FROM_AIRCRAFTS_EFFECTIVE_COUNT = 2600, -- Max amount of aircrafts in region to give full detection bonus.
	...
	ANTI_AIR_PLANE_DAMAGE_FACTOR = 0.2,					-- Anti Air Gun Damage factor
...
NNavy = {
	...
	CARRIER_STACK_PENALTY_EFFECT = 0.3,								-- Each carrier above the optimal amount decreases the amount of airplanes being able to takeoff by such %.
	...
	NAVAL_TRANSFER_DAMAGE_REDUCTION = 0.6,							-- its hard to specifically balance 1-tick naval strikes vs unit transports so here is a factor for it
	...
	NAVY_VISIBILITY_BONUS_ON_RETURN_FOR_REPAIR = 0.6,				-- Multiplier for the surface/sub visiblity when the heavily damaged fleet is returning to the home base for reparation. 1.0 = no bonus. 0.0 = invisible.
	...
	SUBMARINE_REVEAL_BASE_CHANCE 									= 20,		-- Base factor for submarine detection. It's modified by the difference of a spotter's submarines detection vs submarine visibility. Use this variable for game balancing. setting this too low will cause bad spotting issues.
