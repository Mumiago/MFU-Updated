...
NCountry = {
	...
	SUPPLY_FROM_DAMAGED_INFRA = 0.35,                -- damaged infrastructure counts as this in supply calcs
...
NMilitary = {
	...
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.0152,    -- air global damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.0132,    -- global damage modifier
	...
	BASE_FORT_PENALTY = -0.125, 					   -- fort penalty
	...
	ENEMY_AIR_SUPERIORITY_DEFENSE = 0.333,	       -- more AA attack will approach this amount of help (diminishing returns)
	...
	FUEL_CAPACITY_DEFAULT_HOURS = 576              -- default capacity if not specified
},
...
NAir = {			
	...
	ANTI_AIR_ATTACK_TO_DAMAGE_REDUCTION_FACTOR = 0.2,	-- Balancing value to convert equipment stat anti_air_attack to the damage reduction modifier apply to incoming air attacks against units with AA.
...
NNavy = {
	...
	NAVAL_COMBAT_AIR_CAPITAL_TARGET_SCORE = 225,
	NAVAL_COMBAT_AIR_CARRIER_TARGET_SCORE = 150,
