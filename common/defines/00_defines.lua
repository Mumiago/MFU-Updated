...
NDoctrines = {
        ...
        BASE_MASTERY_GAIN_TARGET_MANPOWER = 30000.0,           -- Beyond this amount of manpower contributing to mastery, mastery gain will start having diminishing returns (see doctrines documentation)
