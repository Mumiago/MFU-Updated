...
NCountry = {
	...
	FUEL_LEASE_CONVOY_RATIO = 0.0012,				-- num convoys needed per fuel land lease 
...
NMilitary = {
	...
	ATTRITION_EQUIPMENT_PER_TYPE_LOSS_CHANCE = 0.3, -- Chance for loosing equipment when suffer attrition. Scaled up the stronger attrition is. Then scaled down by equipment reliability.
