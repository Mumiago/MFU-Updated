...
NDiplomacy = {
	TENSION_PEACE_FACTOR_THREAT_FACTOR = 0.2,		-- see above
	...
	TENSION_STATE_VALUE = 0.3,						-- Tension value gained by annexing one state
	...
	TENSION_PEACE_FACTOR = 0.8,						-- scale of the amount of tension (from war declaration) reduced when peace is completed.
...
NCountry = {
	...
	REINFORCEMENT_EQUIPMENT_DELIVERY_SPEED = 0.225,	-- Modifier for army equipment reinforcement speed (MFU: 0.3 -> 0.225, ~25% slower reinforcement)
	REINFORCEMENT_MANPOWER_DELIVERY_SPEED = 37.5,	-- Modifier for army manpower reinforcement delivery speed (travel time) (MFU: 50.0 -> 37.5, ~25% slower reinforcement)
	...
	AIR_SUPPLY_CONVERSION_SCALE = 0.07,				-- Conversion scale for planes to air supply
	...
	SPECIAL_FORCES_CAP_MIN = 54,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NResistance = {
	...
	MIN_DAMAGE_TO_GARRISONS_MODIFIER = 0.15, -- modifier that applies to losses from resistance attack to garrisons at most can be reduced to this amount
	...
	RESISTANCE_ACTIVITY_MIN_GARRISON_PENETRATE_CHANCE = 0.04,
...
NProduction = {
	...
	BASE_FACTORY_EFFICIENCY_GAIN = 0.65,		-- Base efficiency gain for factories per unit produced in %. 1.00
	...
	BASE_FACTORY_EFFICIENCY_PARENT_CHANGE_FACTOR = 25,		-- Base factor for changing production parent<->children in %.
	BASE_FACTORY_EFFICIENCY_FAMILY_CHANGE_FACTOR = 60,		-- Base factor for changing production with same family in %.
	BASE_FACTORY_EFFICIENCY_ARCHETYPE_CHANGE_FACTOR = 15, 	-- Base factor for changing production with same archetype in %.
	...
	LICENSE_EQUIPMENT_TECH_SPEED_PER_YEAR = -0.2,		-- MIC speed modifier for licensed equipment for each year of difference between actual and latest equipment
...
NTechnology = {
	...
	LICENSE_PRODUCTION_TECH_BONUS = 0.10,	-- License production tech bonus
...
NMilitary = {
	...
	MAX_NUM_AUTOMEDALS = 10,						-- You can't get more medals from the automedal system than this.
	...
	FIELD_EXPERIENCE_ON_DIVISION_PER_MEDAL_MULT = 0.2,	--Multiply officer field experience gain by this * number of division medals on application
	...
	NAVAL_INVASION_PLANNING_BONUS_MALUS = -0.3,		-- Malus in percentage for the planning bonus gain for naval invasions
	...
	LAND_COMBAT_COLLATERAL_FORT_FACTOR = 0.003,		-- Factor to scale collateral damage to forts with.
	...
	MAX_DIVISION_SUPPORT_WIDTH = 1,			-- Max width of support in division designer. (MFU: 1 column - vanilla only ever uses 1; >1 crashes the designer)
	MAX_DIVISION_SUPPORT_HEIGHT = 8,		-- Max height of support in division designer. (MFU: 8 support slots in one column)
	...
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.043,        -- global damage modifier
	...
	LAND_COMBAT_FORT_DAMAGE_CHANCE = 9,		-- chance to get a hit to damage on forts. (out of 100)
	...
	ENEMY_AIR_SUPERIORITY_DEFENSE_STEEPNESS = 125, -- how quickly defense approaches the max impact diminishing returns curve
	...
	OUT_OF_SUPPLY_SPEED = -0.15,                    -- max speed reduction from supply
	...
	COMBAT_OVER_WIDTH_PENALTY = -0.9,					-- over combat width penalty per %.
	...
	BATALION_CHANGED_EXPERIENCE_DROP = 0.2,			-- Division experience drop if unit has different batalion
...
NAir = {
	--NOSURE
	CARRIER_PERCENTAGE_DEFEND = 0.5,					-- Percentage of planes able to defend a carrier from air attacks (historically 15% - 35%)
	...
	AIR_WING_ATTACK_LOGISTICS_TRUCK_MAX_FACTOR = 0.04, -- max trucks we can destroy in one instance of a logistics strike
	...
	ANTI_AIR_PLANE_DAMAGE_FACTOR = 0.16,					-- Anti Air Gun Damage factor
	ANTI_AIR_PLANE_DAMAGE_CHANCE = 0.24,					-- Anti Air Gun hit chance
	...
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_TACTICAL_BOMBER = 0.148,	-- How much efficiency to regain per day. Gain applied hourly.
...
NSupply = {
	...
	NODE_ADDED_PENALTY_PER_PROVINCE = 0.8,
	...
	NAVAL_BASE_ADDED_PENALTY_PER_PROVINCE = 1.7,
	...
	AVAILABLE_MANPOWER_STATE_SUPPLY = 0.6,						--Factor for state supply from max manpower (population)
	STORED_SUPPLY_CONSUMPTION_RATE_FACTOR = 0.9,				--Multiplies consumption rate of stored supply (more/less easement)
},
NRailwayGun = {
...
NNavy = {
	...
	AMPHIBIOUS_INVADE_SPEED_BASE = 0.1, 							-- every hour movement progress on amphibious invasion
	AMPHIBIOUS_INVADE_MOVEMENT_COST = 24.0, 						-- total progress cost of movement while amphibious invading
	...
	NAVAL_COMBAT_SUB_DETECTION_FACTOR                               = 2,      -- balance value for sub detection in combat by ships
	...
	SUBMARINE_REVEAL_POW 											= 7.5,		-- A scaling factor that is applied to the reveal chance in order to make large differences in detection vs visibility more pronounced
	...
	NAVAL_COMBAT_AIR_SUB_DETECTION_FACTOR = 0.035,				--# 0.035		-- A global factor that applies after all others, right before the sub detection contributed by plane is added to the global sub detection of a combatant
...
NIntel = {
	...
	RECON_INTEL_BONUS = 0.05,                                      -- each recon gives this bonus to overall gathered land intel in combat
...
NDoctrines = {
        ...
        BASE_MASTERY_GAIN_TARGET_MANPOWER = 35000.0,           -- Beyond this amount of manpower contributing to mastery, mastery gain will start having diminishing returns (see doctrines documentation)
