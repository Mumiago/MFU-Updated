...
NDiplomacy = {
	TENSION_PEACE_FACTOR_THREAT_FACTOR = 0,		-- see above
	...
	TENSION_PEACE_FACTOR = 0.6,						-- scale of the amount of tension (from war declaration) reduced when peace is completed.
