...
NMilitary = {
	...
	EQUIPMENT_COMBAT_LOSS_FACTOR = 0.38,	 	       -- % of equipment lost to strength ratio in combat, so some % is returned if below 1
...
NAir = {
	...
	NAVAL_STRIKE_DAMAGE_TO_STR = 1.55,					-- Balancing value to convert damage ( nanaval_strike_attackval_strike_attack * hits ) to Strength reduction.
...
NNavy = {
	...
	COMBAT_DAMAGE_TO_STR_FACTOR = 0.4,								-- casting damage value to ship strength multiplier. Use it ot balance the game difficulty.
