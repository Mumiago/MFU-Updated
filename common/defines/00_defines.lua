...
NSupply = {
	...
	SUPPLY_HUB_MOTORIZATION_MARGINAL_EFFECT_DECAY = 1.4,
	...
	NAVAL_BASE_FLOW = 4, -- max output/input of a naval node is limited by this base value + additional ratio for each level
