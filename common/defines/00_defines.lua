...
NMilitary = {
	...
	EQUIPMENT_COMBAT_LOSS_FACTOR = 0.37,	 	       -- % of equipment lost to strength ratio in combat, so some % is returned if below 1
	...
	BASE_CAPTURE_EQUIPMENT_RATIO = 0,				-- after a successful land combat, ratio of the equipments that are being captured/salvaged from enemy's lost equipment
...
NAir = {
	...
	NAVAL_STRIKE_DAMAGE_TO_STR = 1.43,					-- Balancing value to convert damage ( nanaval_strike_attackval_strike_attack * hits ) to Strength reduction.
...
NRailwayGun = {
	...
	BASE_CAPTURE_CHANCE = 10,						-- The base chance of railway guns being captured during an overrrun. Will be further modified by the equipment capture chance of the capturing unit.
...
NNavy = {
	...
	COMBAT_DAMAGE_TO_STR_FACTOR = 0.36,								-- casting damage value to ship strength multiplier. Use it ot balance the game difficulty.
	...
	NAVAL_TRANSFER_DAMAGE_REDUCTION = 0.15,							-- its hard to specifically balance 1-tick naval strikes vs unit transports so here is a factor for it
