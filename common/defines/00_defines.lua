...
NMilitary = {
	...
	MAX_NUM_AUTOMEDALS = 1000,						-- You can't get more medals from the automedal system than this.
	...
	LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.048,        -- global damage modifier... but some equipment is returned at end of battles see : EQUIPMENT_COMBAT_LOSS_FACTOR
	...
	CHANCE_TO_AVOID_HIT_AT_NO_DEF = 55,	           -- chance to avoid hit if no defences left.
