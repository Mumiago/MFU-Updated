...
NCountry = {
	...
	SPECIAL_FORCES_CAP_MIN = 81,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NDoctrines = {
        DEFAULT_REWARD_MASTERY = 260.0,                         -- How much mastery is required for unlocking a doctrine reward, if no override is set
        BASE_MASTERY_GAIN_TARGET_MANPOWER = 190000.0,           -- Beyond this amount of manpower contributing to mastery, mastery gain will start having diminishing returns (see doctrines documentation)
        ...
        MASTERY_BAR_ANIMATION_SPEED_PER_DAILY_MASTERY = 2.0, -- Multiplier of how fast the mastery bar animates based on daily mastery gain
        ...
        MASTERY_BANK_MAX = 400.0,                               -- The maximum amount of mastery that can be banked
