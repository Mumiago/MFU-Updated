...
NDefines.NMilitary.MAX_HQ_BATTALION_HEIGHT = 5 -- Army HQ designer: rows in the HQ line-battalion grid (so up to 1x4 line battalions)
NDefines.NMilitary.MAX_HQ_SUPPORT_WIDTH = 1 -- Army HQ designer: columns in the HQ support-company grid
NDefines.NMilitary.MAX_HQ_SUPPORT_HEIGHT = 4 -- Army HQ designer: rows in the HQ support-company grid 
...
NDefines.NMilitary.COMMANDER_ABILITY_BASE_RANGE = 10 -- base range (provinces) of a commander/HQ ability's area of effect
...
NDefines.NMilitary.PLANNING_CAP_COMMS_SCALING = { 1.2, 1, 0.8, 0.6, 0.5} -- max-planning multiplier indexed by comms distance (0..4 hops from HQ)
NDefines.NMilitary.PLANNING_CAP_NO_HQ_SCALING = 0.5 -- max-planning multiplier for units that have no Army HQ
NDefines.NMilitary.PLANNING_SPEED_COMMS_SCALING = { 1.2, 1, 0.8, 0.6, 0.5} -- planning-speed multiplier indexed by comms distance
NDefines.NMilitary.PLANNING_SPEED_NO_HQ_SCALING = 0.5 -- planning-speed multiplier for units with no Army HQ
NDefines.NMilitary.LEADER_MOD_COMMS_SCALING = { 1.4, 1.2, 0.8, 0.5, 0.3} -- HQ leader-modifier effectiveness multiplier by comms distance
NDefines.NMilitary.LEADER_MOD_NO_HQ_SCALING = 0.3 -- HQ leader-modifier effectiveness when no HQ
NDefines.NMilitary.ABILITY_COMMS_SCALING = { 1.4, 1.2, 0.8, 0.5, 0.3 } -- HQ ability effectiveness multiplier by comms distance
NDefines.NMilitary.ABILITY_NO_HQ_SCALING = 0.3 -- HQ ability effectiveness when no HQ
