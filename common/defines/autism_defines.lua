...
NDefines.NGame.GAME_SPEED_SECONDS = { 600.0, 0.26, 0.25, 0.19, 0}
---Diplomacy
...
NDefines.NMilitary.PLANNING_CAP_COMMS_SCALING = { 1.4, 1.2, 0.8, 0.5, 0.3} -- max-planning multiplier indexed by comms distance (0..4 hops from HQ)
NDefines.NMilitary.PLANNING_CAP_NO_HQ_SCALING = 0.3 -- max-planning multiplier for units that have no Army HQ
NDefines.NMilitary.PLANNING_SPEED_COMMS_SCALING = { 1.4, 1.2, 0.8, 0.5, 0.3} -- planning-speed multiplier indexed by comms distance
NDefines.NMilitary.PLANNING_SPEED_NO_HQ_SCALING = 0.3 -- planning-speed multiplier for units with no Army HQ
